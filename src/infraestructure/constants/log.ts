...
const ControllerMsg = {
    success: {
        CREATE_CARD_SUCCESS:"CREATE_CARD_SUCCESS",              //Indica que se realizó una solicitud de tarjeta física y esta fue exitosa
        ACTIVATED_CARD_SUCCESS:"ACTIVATED_CARD_SUCCESS",        //Indica que se realizó una activación  de tarjeta física y esta fue exitosa
    ...
    error: {
        CREATE_CARD_FAILURE: "CREATE_CARD_FAILURE",             //Indica que se realizó una solicitud de tarjeta física y esta falló
        ACTIVATED_CARD_FAILURE:"ACTIVATED_CARD_FAILURE",        //Indica que se realizó una activación de tarjeta física y esta falló
        RETURN_DATA_CARD_FAILURE: "RETURN_DATA_CARD_FAILURE",   //Indica que se intentó mostrar la información privada de la tarjeta física y esta falló
...
export = { events, ControllerMsg, Operations }
